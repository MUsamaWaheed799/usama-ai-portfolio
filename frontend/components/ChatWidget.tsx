...
type Message = { role: Role; content: string; sources?: Source[]; error?: boolean };
      ...
      {open && (
        <div className="glass fixed bottom-24 right-6 z-50 flex h-[32rem] w-[22rem] flex-col rounded-2xl shadow-2xl sm:w-96">
          <div className="flex items-center gap-2 border-b border-border/60 px-4 py-3">
            ...
            <div>
              <p className="text-sm font-semibold">Usama AI Assistant</p>
              <p className="text-xs text-muted-foreground">Grounded in Usama's real profile data</p>
            </div>
          </div>
